...
try:
    from parser import utils, configs, main
...
def tempfile_session() -> Generator[Any, Any, Any]:
...
@pytest.fixture(scope='function')
def mock_session(tempfile_session) -> Generator[Any, Any, Any]:
